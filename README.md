...
Associate Data Scientist with 1 year of hands-on experience in data analysis, visualization, and deriving actionable insights from complex datasets. Complemented by 5+ years as a Business Development Manager, bringing strategic thinking, stakeholder management, and business acumen to data-driven problem solving. Passionate about using Python and SQL to translate data into actionable intelligence that drives business growth and informs critical decision-making.
...
**Machine Learning**
- Scikit-learn, XGBoost, Linear Regression, Random Forest, Gradient Boosting

**Business Development & Analytics**
- Stakeholder Management, Strategic Analysis, Business Intelligence, Market Insights
